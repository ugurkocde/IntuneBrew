#!/bin/bash
# Uninstall script for ClickShare
# Generated by IntuneBrew

# Exit on error
set -e

echo "Uninstalling ClickShare..."
...
# Remove /Applications/ClickShare.app
echo "Removing /Applications/ClickShare.app..."
if [ -d "/Applications/ClickShare.app" ]; then
    rm -rf "/Applications/ClickShare.app" 2>/dev/null || true
elif [ -f "/Applications/ClickShare.app" ]; then
...
echo "Removing $HOME/Library/Preferences/com.barco.clickshare*.plist..."
if [ -d "$HOME/Library/Preferences/com.barco.clickshare*.plist" ]; then
    rm -rf "$HOME/Library/Preferences/com.barco.clickshare*.plist" 2>/dev/null || true
elif [ -f "$HOME/Library/Preferences/com.barco.clickshare*.plist" ]; then
    rm -f "$HOME/Library/Preferences/com.barco.clickshare*.plist" 2>/dev/null || true
fi
