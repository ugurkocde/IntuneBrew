#!/bin/bash
# Uninstall script for Microsoft Office BusinessPro
# Generated by IntuneBrew

# Exit on error
set -e

echo "Uninstalling Microsoft Office BusinessPro..."
...
echo "Stopping Microsoft Office BusinessPro if running..."
pkill -f "Microsoft Office BusinessPro" 2>/dev/null || true
